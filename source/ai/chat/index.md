...
var MM = {gpt:'gpt-5.4-mini', deepseek:'deepseek-v4-pro', grok:'grok-4-1-fast-reasoning', minimax:'minimax-m4', glm:'glm-5.2', qwen:'qwen-3.7'};
var ML = {gpt:'GPT-5.4-mini', deepseek:'DeepSeek V4 Pro', grok:'Grok 4.1 Fast', minimax:'MiniMax M4', glm:'GLM 5.2', qwen:'Qwen 3.7'};
var messages = [];
var busy = false;
